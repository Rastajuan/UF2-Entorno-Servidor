...
if (isset($_POST['botonEntrar'])) {
    if ($_POST['usuario'] == 'ifp'  && $_POST['password'] == '2022') {
        ...
        //Creamos la cookie en el navegador, asignándole un primer nombre, segido del nombre del usuario recogido en $nombreusuario, seguido del tiempo que debe guardar la cookie (momento actual con time() + el tiempo en segundos que la debe guardar (una hora en el ejercicio), seguido de'/' que le indica la raiz o pagina principal de la sesión)
...
<body>
    ...
    <section>
        <fieldset>
            <legend class="negrita">Introduzca usuario y contraseña
            </legend>
